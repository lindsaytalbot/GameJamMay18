...
public class UTNotification {
    ...
    UTNotification(final long triggerAtSystemTimeMillis, final int intervalSeconds, final String title, final String text, final int id, final Map<String, String> userData, final String notificationProfile, final int badgeNumber, final String buttonsJson) throws JSONException {
        this(triggerAtSystemTimeMillis, intervalSeconds, title, text, id, userData, notificationProfile, badgeNumber, buttonsJsonToListOfButtons(buttonsJson));
    }
    ...
    static JSONObject userDataToJson(Map<String, String> userData) throws JSONException {
