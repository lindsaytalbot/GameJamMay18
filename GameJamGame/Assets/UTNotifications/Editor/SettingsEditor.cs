    ...
    //private
        ...
        private void DrawAndroid()
        {
            if (m_showAndroid = EditorGUILayout.Foldout(m_showAndroid, "Android"))
            {
                ...
                bool bgColorSpecified = EditorGUILayout.Toggle(m_android5PlusIconBGColorLabel, m_profile.androidIconBGColorSpecified);
                if (bgColorSpecified && !m_profile.androidIconBGColorSpecified && m_profile.androidIconBGColor == new Color(0, 0, 0, 0))
                {
                    m_profile.androidIconBGColor = Color.gray;
                }
                m_profile.androidIconBGColorSpecified = bgColorSpecified;
                if (m_profile.androidIconBGColorSpecified)
                {
                    m_profile.androidIconBGColor = EditorGUILayout.ColorField(m_profile.androidIconBGColor);
                }
                EditorGUILayout.EndHorizontal();
        ...
        private GUIContent m_android5PlusIconBGColorLabel = new GUIContent("Small Icon BG Color (Android 5-7)", "The background color for the small icon on Android 5.0+");
